...
const mockGetImages = {
  "data": {
    "collection": {
      ...
      "links": [
        {
          "href": "https://images-api.nasa.gov/search?page=2&q=moon",
          "rel": "next",
          "prompt": "Next"
        }
      ],
